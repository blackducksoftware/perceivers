...
func makeImageAnnotationObj() *bdannotations.BlackDuckImageAnnotation {
	image := scannedImages[0]
	return bdannotations.NewBlackDuckImageAnnotation(image.PolicyViolations, image.Vulnerabilities, image.OverallStatus, image.ComponentsURL, results.HubVersion, results.HubScanClientVersion)
}
