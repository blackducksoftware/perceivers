...
import (
	...
	"github.com/blackducksoftware/perceivers/docker/cmd/app"
...
func main() {
	log.Info("starting docker-perceiver")
	...
	// Create the Docker Perceiver
	perceiver, err := app.NewDockerPerceiver(handler, os.Args[1])
	if err != nil {
		panic(fmt.Errorf("failed to create docker-perceiver: %v", err))
	}
